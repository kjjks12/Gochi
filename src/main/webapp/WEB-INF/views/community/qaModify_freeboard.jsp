				...
				<div class="col-sm-3 col-md-3" id="block-menu-content">
					...
					<div class="col-sm-9 col-md-9">
						<div class="info-block">
							...
							<div class="row">
							<form name="modifyForm" method="post" action="${pageContext.request.contextPath}/community/qamodify">
									<input id=qaBoardNo type="hidden" name="qaBoardNo" value="${qaboardDTO.qaBoardNo}">
								<div class="col-md-5 space-form">
									<input id="qaTitle" class="form-control" type="text" placeholder="제목" name="qaTitle" value="${qaboardDTO.qaTitle}">
								</div>
								<div class="col-md-7 space-form">
									<input id="nickName" class="form-control" type="text" value="${sessionScope.dto.nickname}"/>
								</div>
								<div class="col-md-12">
									<textarea name="qaContent" id="qaContent" class="form-control description">${qaboardDTO.qaContent}</textarea>
								</div>
							</form>
