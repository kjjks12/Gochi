	...
	<div id="page-container">
		...
		<section id="header-page" class="header-margin-base">
			<div class="skyline">
				...
				<div data-offset="35" class="p3 parallax"></div>
				<div data-offset="8"  class="p4 parallax"></div>
				<span class="cover"></span>
				<div class="container header-text">
					<div><h1 class="title">Blog list</h1></div>
					<div><h2 class="sub-title">Lorem ipsum dolor sits adipiscing elit justo</h2></div>
				</div>
			</div>
			<div id="breadcrumb">
				<div class="container">
				...
				<div class="row">
					<div class="col-md-9">
						<div class="row blog-list">
							<div class="col-md-5">
								<div class="social">
									<span class="date">26<span>Mar</span></span>
									<a href="#"><i class="fa fa-heart-o"></i><span>9634</span></a>
									<a href="#"><i class="fa fa-eye"></i><span>64982</span></a>
									<a href="#"><i class="fa fa-comments"></i><span>129</span></a>
								</div>
							...
							<div class="col-md-7">
								<h2 class="title"><a href="blog-detail.html">finibus feugiat mauris facilisis eu</a></h2>
								<h3 class="subtitle">Vestibulum interdum mauris et mattis.</h3>
								<div class="text">Lorem Ipsum is simply All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true genator on the Internet. Lorem Ipsum is simply dummy text of the printing and types industry. Lorem Ipsum has been the industry's</div>
						...
						<div class="row blog-list">
							<div class="col-md-5">
								<div class="social">
									...
									<a href="#"><i class="fa fa-heart-o"></i><span>1238</span></a>
									<a href="#"><i class="fa fa-eye"></i><span>236498</span></a>
									<a href="#"><i class="fa fa-comments"></i><span>115</span></a>
								</div>
								<div class="image image-fill">
									<img src="http://placehold.it/1280x850/bbbbbb/ffffff" alt="Image Sample" />
								</div>
							...
							<div class="col-md-7">
								<h2 class="title"><a href="blog-detail.html">Vestibulum pulvinar id lectus nec dapibus</a></h2>
								<h3 class="subtitle">Internet tend to repeat predefiry, making</h3>
								<div class="text">Lorem Ipsum is simply All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true genator on the Internet. Lorem Ipsum is simply dummy text of the printing and types industry. Lorem Ipsum has been the industry's</div>
								<input type="button" value="Read now" class="btn btn-default" />
							</div>
						</div><!-- /.blog-list -->
						<div class="row blog-list">
							<div class="col-md-5">
								<div class="social">
									...
									<a href="#"><i class="fa fa-heart-o"></i><span>948</span></a>
									<a href="#"><i class="fa fa-eye"></i><span>94635</span></a>
									<a href="#"><i class="fa fa-comments"></i><span>46</span></a>
								</div>
								<div class="image image-fill">
									<img src="http://placehold.it/1280x850/bbbbbb/ffffff" alt="Image Sample" />
								</div>
							...
							<div class="col-md-7">
								<h2 class="title"><a href="blog-detail.html">Cras in iacalis velit. Integer eu </a></h2>
								<h3 class="subtitle">Tend to repeat predefined chunks as necessary, making</h3>
								<div class="text">Lorem Ipsum is simply All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true genator on the Internet. Lorem Ipsum is simply dummy text of the printing and types industry. Lorem Ipsum has been the industry's</div>
								<input type="button" value="Read now" class="btn btn-default" />
							</div>
						</div><!-- /.blog-list -->
						<div class="row blog-list">
							<div class="col-md-5">
								<div class="social">
									...
									<a href="#"><i class="fa fa-heart-o"></i><span>369</span></a>
									<a href="#"><i class="fa fa-eye"></i><span>4672</span></a>
									<a href="#"><i class="fa fa-comments"></i><span>63</span></a>
								</div>
								<div class="image image-fill">
									<img src="http://placehold.it/1280x850/bbbbbb/ffffff" alt="Image Sample" />
								</div>
							...
							<div class="col-md-7">
								<h2 class="title"><a href="blog-detail.html">Mauris vitae fringilla ipsum</a></h2>
								<h3 class="subtitle">Is simply dummy text of the pr</h3>
								<div class="text">Lorem Ipsum is simply All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true genator on the Internet. Lorem Ipsum is simply dummy text of the printing and types industry. Lorem Ipsum has been the industry's</div>
								<input type="button" value="Read now" class="btn btn-default" />
							</div>
						</div><!-- /.blog-list -->
						<div class="row blog-list">
							<div class="col-md-5">
								<div class="social">
									<span class="date">6<span>Mar</span></span>
									<a href="#"><i class="fa fa-heart-o"></i><span>649</span></a>
									<a href="#"><i class="fa fa-eye"></i><span>136945</span></a>
									<a href="#"><i class="fa fa-comments"></i><span>25</span></a>
								</div>
								<div class="image image-fill">
									<img src="http://placehold.it/670x960/bbbbbb/ffffff" alt="Image Sample" />
								</div>
							</div>
							<div class="col-md-7">
								<h2 class="title"><a href="blog-detail.html">Making this the first true genator</a></h2>
						...
						<div class="row blog-list">
							<div class="col-md-5">
								<div class="social">
									<span class="date">26<span>Feb</span></span>
									<a href="#"><i class="fa fa-heart-o"></i><span>783</span></a>
									<a href="#"><i class="fa fa-eye"></i><span>64976</span></a>
									<a href="#"><i class="fa fa-comments"></i><span>58</span></a>
								</div>
								<div class="image image-fill">
									<img src="http://placehold.it/700x900/bbbbbb/ffffff" alt="Image Sample" />
								</div>
							</div>
							<div class="col-md-7">
								<h2 class="title"><a href="blog-detail.html">Pellentesque iaculis varius diam at ullamcorper</a></h2>
								<h3 class="subtitle">Lorem Ipsum to repeat predefined chunks as necessary</h3>
								<div class="text">Lorem Ipsum is simply All the generators on the Internet tend to repeat predefined chunks as necessary, making this the first true genator on the Internet. Lorem Ipsum is simply dummy text of the printing and types industry. Lorem Ipsum has been the industry's</div>
								<input type="button" value="Read now" class="btn btn-default" />
							</div>
						</div><!-- /.blog-list -->
						<div class="row blog-list">
							<div class="col-md-5">
								<div class="social">
									...
									<a href="#"><i class="fa fa-heart-o"></i><span>264</span></a>
									<a href="#"><i class="fa fa-eye"></i><span>6457</span></a>
									<a href="#"><i class="fa fa-comments"></i><span>57</span></a>
								</div>
								<div class="image image-fill">
									<img src="http://placehold.it/1280x680/bbbbbb/ffffff" alt="Image Sample" />
								</div>
							</div>
							<div class="col-md-7">
								<h2 class="title"><a href="blog-detail.html">Curabitur metus elit, faucibus ac malesuada</a></h2>
								<h3 class="subtitle">Praesent dignissim a mi in pellentesque</h3>
								<div class="text">Lorem Ipsum is simply All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true genator on the Internet. Lorem Ipsum is simply dummy text of the printing and types industry. Lorem Ipsum has been the industry's</div>
								<input type="button" value="Read now" class="btn btn-default" />
							</div>
						</div><!-- /.blog-list -->
