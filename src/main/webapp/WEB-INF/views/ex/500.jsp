			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<span class="title"><span>5<img src="images/broken-pin.png" alt="" />0</span> Error!</span>
						<h2 class="line-broken">Malformed Header</h2>
						<div class="text">
							The server encountered an internal error or misconfiguration and was unable to complete your request.<br />
							Please contact the administrator, and inform them of the time the error occurred, and anything you might have done that may have caused the error. 
						</div>
						<a href="#" class="btn btn-default error-button">Report broken link </a>
						<a href="#" class="btn btn-default error-button">Visit the Home Page</a>
					</div>
				</div>
			</div>
		</section>
