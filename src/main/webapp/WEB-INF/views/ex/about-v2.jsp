	...
	<div id="page-container">
		...
		<section id="header-page" class="header-margin-base">
			<div class="skyline">
				...
				<div class="container header-text">
					<div><h1 class="title">About Us v2</h1></div>
					<div><h2 class="sub-title">Lorem ipsum dolor sitts adipiscing elit justo</h2></div>
				</div>
			</div>
			<div id="breadcrumb">
				<div class="container">
		...
		<section id="about-us">
			<div class="section-detail">
				<h1>About Us</h1>
				<h2>Lorem ipsum dolor sit amet, consectetur adipiscinec dolor, sagittis sed elementum dignissim.</h2>
			</div><br />
			<div class="team sample-about">
				<div class="container">
					<div class="row">
							...
							<div class="agent-box-card">
								<div class="image-content">
									<div class="image image-fill">
										<img src="http://placehold.it/512/bbbbbb/ffffff" alt="Img Sample" />
									</div>						
								</div>
						...
						<div class="col-sm-6 col-md-3">
							<!-- 1. Agent Box -->
							<div class="agent-box-card top-agent">
								<div class="image-content">
									<div class="image image-fill">
										<img src="http://placehold.it/512/bbbbbb/ffffff" alt="Img Sample" />
									</div>						
