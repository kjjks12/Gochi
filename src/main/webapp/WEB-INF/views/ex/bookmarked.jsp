		...
		<section id="header-page" class="header-margin-base">
			<div class="skyline">
				...
				<div class="container header-text">
					<div><h1 class="title">Bookmark</h1></div>
					<div><h2 class="sub-title">Lorem ipsumetur ats adipiscing elit justo</h2></div>
				</div>
			</div>
			<div id="breadcrumb">
				<div class="container">
					...
					<div class="col-sm-4 col-md-3">
						...
						<div class="agent-box-card grey">
							...
							<div class="info-agent">
								<span class="name">Adam West</span>
								<ul class="contact">
						...
						<br />
						<ul class="block-menu">
							<li><a class="faq-button" href="profile.html"><i class="icon fa fa-user-secret"></i> Profile</a></li>
							<li><a class="faq-button" href="my-properties.html"><i class="icon fa fa-home"></i> My Property</a></li>
							<li><a class="faq-button active" href="bookmarked.html"><i class="icon fa fa-heart"></i> Bookmarked</a></li>
							<li><a class="faq-button" href="new-property.html"><i class="icon fa fa-plus"></i> Create New Property</a></li>
						</ul>
					</div>
					<div class="col-sm-8 col-md-9">
						<div class="section-title line-style no-margin">
							<h3 class="title">Bookmarked Property</h3>
						</div>
						<div class="row">
							<div class="col-sm-12 col-md-6 col-lg-4">
								<div class="box-ads box-grid mini">
									...
									<span class="price">$ 234.500,00</span>
									...
									<dl class="detail">
										...
										<dt class="bed">Beds:</dt><dd><span>7</span></dd>
										<dt class="bath">Baths:</dt><dd><span>5</span></dd>
									</dl>
									<div class="footer">
										<a class="btn btn-danger" href="property-detail.html"><i class="fa fa-trash-o"></i></a>
									</div>
								</div><!-- /.box-ads -->
							</div>
							<div class="col-sm-12 col-md-6 col-lg-4">
								<div class="box-ads box-grid mini">
									...
									<span class="price">$ 456.500,00</span>
							...
							<div class="col-sm-12 col-md-6 col-lg-4">
								<div class="box-ads box-grid mini">
									...
									<dl class="detail">
										<dt class="status">Status:</dt><dd><span>Sale</span></dd>
										<dt class="bed">Beds:</dt><dd><span>4</span></dd>
										<dt class="bath">Baths:</dt><dd><span>4</span></dd>
									</dl>
									<div class="footer">
										<a class="btn btn-danger" href="property-detail.html"><i class="fa fa-trash-o"></i></a>
									</div>
							...
							<div class="col-sm-12 col-md-6 col-lg-4">
								<div class="box-ads box-grid mini">
									<a class="hover-effect image image-fill" href="property-detail.html">
										<span class="cover"></span>
										<img alt="Sample images" src="http://placehold.it/1240x745/bbbbbb/ffffff">
										<h3 class="title">223 E 6th St</h3>
									</a>
									<span class="price">$ 364.500,00</span>
									<span class="address"><i class="fa fa-map-marker"></i> New York, NY 10003, USA</span>
									<span class="description">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by insages of Lorem Ipsum available, but the majority have suffered alteratiojected humour.</span>
									<dl class="detail">
										<dt class="status">Status:</dt><dd><span>Sale</span></dd>
							...
							<div class="col-sm-12 col-md-6 col-lg-4">
								<div class="box-ads box-grid mini">
									...
									<span class="price">$ 964.500,00</span>
									<span class="address"><i class="fa fa-map-marker"></i> Jersey City, NJ 07302, USA</span>
									<span class="description">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by insages of Lorem Ipsum available, but the majority have suffered alteratiojected humour.</span>
									<dl class="detail">
										<dt class="status">Status:</dt><dd><span>Sale</span></dd>
							...
							<div class="col-sm-12 col-md-6 col-lg-4">
								<div class="box-ads box-grid mini">
									<a class="hover-effect image image-fill" href="property-detail.html">
										<span class="cover"></span>
										<img alt="Sample images" src="http://placehold.it/580/bbbbbb/ffffff">
										<h3 class="title">32 Prince St</h3>
									</a>
									<span class="price">$ 369.500,00</span>
									<span class="address"><i class="fa fa-map-marker"></i> New York, NY 10012, USA</span>
									<span class="description">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by insages of Lorem Ipsum available, but the majority have suffered alteratiojected humour.</span>
									<dl class="detail">
										<dt class="status">Status:</dt><dd><span>Sale</span></dd>
										<dt class="bed">Beds:</dt><dd><span>4</span></dd>
