...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="css/vendor/skill-bars/skill-bars.css">             <!-- Skill Bars -->
  ...
  <body class="fixed-header">
		...
		<section id="header-page" class="header-margin-base">
			<div class="skyline">
				...
				<div class="container header-text">
					<div><h1 class="title">Agent Detail</h1></div>
					<div><h2 class="sub-title">Lorem ipsum dolor sit adipiscing elit justo</h2></div>
				</div>
			</div>
			<div id="breadcrumb">
				<div class="container">
				...
				<div class="row">
					<div class="col-md-9">
						<div class="row">
							<div class="col-sm-8 col-md-8 col-sm-push-4">
								<h1 class="name">Diane Hayes</h1>
								<span class="text">
									Morbi interdum dictum neque, vitae mattis tortor vehicula convallis. Integer sagittis nec turpis vel elementum. Sed suscipit nunc in odio auctor semper. Vivamus pretium, nisl sed cursus ultrices, odio enim pharetra magna.
								</span>
								<div class="bs-callout callout-success">
								  <h4 class="title">Nullam sodales lorem sit amet</h4>
								  <p class="text">Phasellus vitae enim porttitor leo convallis ultrices sit amet eget mi. Aliquam quis eleifend est. Maecenas eu rhoncus velit. Aenean venenatis risus vitae dolor tincidunt lacinia. Nulla urna augue, iaculis at aliquam sed, sodales at augue.</p>
								</div>
								<form class="form-contact" method="post" action="contact.php" role="form" data-toggle="validator">
									<div class="row">
										...
										<div class="col-md-12 col-sm-12">
											<textarea name="text-message" id="text-message" class="form-control text-form" placeholder="Your message *" required></textarea>
										</div>
										<div class="col-md-12 col-sm-12">
							...
							<div class="col-sm-4 col-md-4 col-sm-pull-8">
								...
								<div class="skill-box">
									<div class="skillbar" data-percent="50%">
										<div class="skillbar-title"><span>Speaking</span></div>
										<div class="skillbar-bar"></div>
										<div class="skill-bar-percent">50%</div>
									</div> <!-- End Skill Bar -->

									<div class="skillbar" data-percent="40%">
										<div class="skillbar-title"><span>Negotiation</span></div>
										<div class="skillbar-bar"></div>
										<div class="skill-bar-percent">40%</div>
									</div> <!-- End Skill Bar -->

									<div class="skillbar" data-percent="75%">
										<div class="skillbar-title"><span>Persuasion</span></div>
										<div class="skillbar-bar"></div>
										<div class="skill-bar-percent">75%</div>
									</div> <!-- End Skill Bar -->

									<div class="skillbar" data-percent="90%">
										<div class="skillbar-title"><span>Sales</span></div>
										<div class="skillbar-bar"></div>
										<div class="skill-bar-percent">90%</div>
									</div> <!-- End Skill Bar -->

									<div class="skillbar" data-percent="70%">
										<div class="skillbar-title"><span>Altro</span></div>
										<div class="skillbar-bar"></div>
					...
					<div class="col-sm-12 col-md-3">
						...
						<div class="section-title line-style no-margin">
							<h3 class="title">Search Properties</h3>
						</div>
					...
					<div class="crsl-wrap">
						<figure class="crsl-item">
							<div class="box-ads box-grid">
								...
								<span class="price">$ 556.500,00</span>
								<span class="address"><i class="fa fa-map-marker"></i> Hoboken, NJ 07030, USA</span>
								<span class="description">Lorem Ipsum available, but the majority have, There are many variations of passages of  suffered alteration in some form, by insages of Lorem Ipsum available, but the majority have suffered alteratiojected humour.</span>
								<dl class="detail">
									<dt class="status">Status:</dt><dd><span>Sale</span></dd>
									<dt class="bed">Beds:</dt><dd><span>4</span></dd>
									<dt class="bath">Baths:</dt><dd><span>3</span></dd>
								</dl>
								<div class="footer">
						...
						<figure class="crsl-item">
							<div class="box-ads box-grid">
								...
								<span class="price">$ 463.500,00</span>
						...
						<figure class="crsl-item" >
							<div class="box-ads box-grid">
								...
								<span class="price">$ 369.500,00</span>
								<span class="address"><i class="fa fa-map-marker"></i> New York, NY 10011, USA</span>
								<span class="description">Majority have suffered alteratiojected There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by insages of Lorem Ipsum available, but the  humour.</span>
								<dl class="detail">
									<dt class="status">Status:</dt><dd><span>Sale</span></dd>
						...
						<figure class="crsl-item" >
							<div class="box-ads box-grid">
								...
								<span class="price">$ 987.500,00</span>
								<span class="address"><i class="fa fa-map-marker"></i> Hoboken, NJ 07030, USA</span>
								<span class="description">Ipsum available, There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by insages of Lorem but the majority have suffered alteratiojected humour.</span>
								<dl class="detail">
									<dt class="status">Status:</dt><dd><span>Sale</span></dd>
						...
						<figure class="crsl-item" >
							<div class="box-ads box-grid">
								...
								<span class="price">$ 1.260.500,00</span>
								<span class="address"><i class="fa fa-map-marker"></i> New York, NY 10013, USA</span>
								<span class="description">Of passages of Lorem Ipsum available, There are many variations but the majority have suffered alteration in some form, by insages of Lorem Ipsum available, but the majority have suffered alteratiojected humour.</span>
								<dl class="detail">
									<dt class="status">Status:</dt><dd><span>Sale</span></dd>
									<dt class="bed">Beds:</dt><dd><span>3</span></dd>
									<dt class="bath">Baths:</dt><dd><span>2</span></dd>
						...
						<figure class="crsl-item" >
							<div class="box-ads box-grid">
								...
								<span class="price">$ 369.500,00</span>
								<span class="address"><i class="fa fa-map-marker"></i> Hoboken, NJ 07056, USA</span>
								<span class="description">Lorem Ipsum available, but the majority have suffered alteration in There are many variations of passages of some form, by insages of Lorem Ipsum available, but the majority have suffered alteratiojected humour.</span>
								<dl class="detail">
									<dt class="status">Status:</dt><dd><span>Sale</span></dd>
	...
	<script	src="script/vendor/skill-bars/custom.js"></script>						<!-- Skill Bars	Script -->
