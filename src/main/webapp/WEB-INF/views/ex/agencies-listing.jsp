	...
	<div id="page-container">
		...
		<section id="header-page" class="header-margin-base">
			<div class="skyline">
				...
				<div class="container header-text">
					<div><h1 class="title">Agencies</h1></div>
		...
		<section id="agency">
			<div class="section-detail">
				<h1>Agencies</h1>
				<h2>Lorem ipsum dolor sit amectetur adlementum dignissim, lobortis.</h2>		
			</div>
			<div class="container">
				<div class="row agency-box">
					...
					<div class="col-sm-6 col-md-7 center-box col-sm-pull-3 col-md-pull-3">
						<h1 class="title"><a href="agency-detail.html">Diamond SRL</a></h1>
						<h3 class="subtitle"><i class="fa fa-map-marker"></i> 16 Property</h3>
						<span>Curabitur ac elementum ex. Aliquam cursus faucibus velit, in venenatis mauris mollis et. Proin laoreet elit et magna semper lobortis eget id orci. </span>
						<div class="button-container">
							<a class="btn btn-default" href="agency-detail.html" >View Details</a>
						</div>
					</div>
				</div>
				<div class="row agency-box">
					...
					<div class="col-sm-6 col-md-7 center-box col-sm-pull-3 col-md-pull-3">
						<h1 class="title"><a href="agency-detail.html">Building Real Estate</a></h1>
						<h3 class="subtitle"><i class="fa fa-map-marker"></i> 16 Property</h3>
						<span>Curabitur ac elementum ex. Aliquam cursus faucibus velit, in venenatis mauris mollis et. Proin laoreet elit et magna semper lobortis eget id orci. </span>
						<div class="button-container">
							<a class="btn btn-default" href="agency-detail.html" >View Details</a>
				...
				<div class="row agency-box">
					...
					<div class="col-sm-6 col-md-7 center-box col-sm-pull-3 col-md-pull-3">
						<h1 class="title"><a href="agency-detail.html">University RE</a></h1>
						<h3 class="subtitle"><i class="fa fa-map-marker"></i> 16 Property</h3>
						<span>Curabitur ac elementum ex. Aliquam cursus faucibus velit, in venenatis mauris mollis et. Proin laoreet elit et magna semper lobortis eget id orci. </span>
						<div class="button-container">
							<a class="btn btn-default" href="agency-detail.html" >View Details</a>
				...
				<div class="row agency-box">
					...
					<div class="col-sm-6 col-md-7 center-box col-sm-pull-3 col-md-pull-3">
						<h1 class="title"><a href="agency-detail.html">Agency Sun</a></h1>
						<h3 class="subtitle"><i class="fa fa-map-marker"></i> 16 Property</h3>
						<span>Curabitur ac elementum ex. Aliquam cursus faucibus velit, in venenatis mauris mollis et. Proin laoreet elit et magna semper lobortis eget id orci. </span>
						<div class="button-container">
							<a class="btn btn-default" href="agency-detail.html" >View Details</a>
				...
				<div class="row agency-box">
					...
					<div class="col-sm-6 col-md-7 center-box col-sm-pull-3 col-md-pull-3">
						<h1 class="title"><a href="agency-detail.html">Skyatlas Agency</a></h1>
						<h3 class="subtitle"><i class="fa fa-map-marker"></i> 16 Property</h3>
						<span>Curabitur ac elementum ex. Aliquam cursus faucibus velit, in venenatis mauris mollis et. Proin laoreet elit et magna semper lobortis eget id orci. </span>
						<div class="button-container">
							<a class="btn btn-default" href="agency-detail.html" >View Details</a>
