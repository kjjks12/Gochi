			...
			<div class="container">
				<div class="row">
						...
						<ul class="profile create">
							<li>
								...
								<select class="dropdown">
									...
									<option value="diamond-srl">Diamond SRL</option>
									<option value="building-real-estate">Building Real Estate</option>
									<option value="university-re">University RE</option>
									<option value="agency-sun">Agency Sun</option>
									<option value="skyatlas-agency">Skyatlas Agency</option>
								</select>
							</li>
							<li>
								<span>Username</span>
					...
					<div class="col-sm-12 col-md-4">
						...
						<ul class="profile create">
							<li>
								...
								<input type="text" class="form-control" name="place-birth" id="place-birth" />
							</li>
							<li>
								<span>Skype</span> 
					...
					<div class="col-sm-12 col-md-8 text-right">
						<button class="btn btn-default signin-button" type="button"><i class="fa fa-sign-in"></i> Sign up</button>
					</div>
				</div>
			</div>
		</section>
