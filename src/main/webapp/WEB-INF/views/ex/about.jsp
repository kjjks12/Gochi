  ...
  <body class="fixed-header">
	...
	<div id="page-container">
		...
		<section id="header-page" class="header-margin-base">
			<div class="skyline">
				...
				<div class="container header-text">
					...
					<div><h2 class="sub-title">Lorem ipsum dolors adipiscing justo</h2></div>
				</div>
			</div>
			<div id="breadcrumb">
				<div class="container">
		...
		<section id="about-us">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 director-image">
						<img src="http://placehold.it/680x240/bbbbbb/ffffff" alt="Image sample" class="img-responsive center-block" />
					</div>
				</div>
			</div>
			<div class="team">
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-md-offset-3 agent director">
							<!-- 4. Agent Box -->
							<div class="agent-box-card">
								<div class="info-agent">
									<span class="name">Diane Hayes</span>
									<div class="text">Morbi interdum dictum neque, vitae mattis tortor vehicula convallis. Integer sagittis nec turpis vel elementum. Sed suscipit nunc in odio auctor semper. Vivamus pretium, nisl sed cursus ultrices, odio enim pharetra magna, vel maximus leo tellus et arcu. Vivamus cursus augue id sapien dignissim varius.</div>
									<ul class="contact">
					...
					<div class="row">
							...
							<div class="agent-box-card rounded top-agent">
								<div class="image-content">
									<div class="image image-fill">
										<img src="http://placehold.it/512/bbbbbb/ffffff" alt="Image sample" />
									</div>						
								</div>
								<div class="info-agent">
									<span class="name">Manuel Lawrence</span>
						...
						<div class="col-sm-6 col-md-3">
							...
							<div class="agent-box-card rounded top-agent">
								...
								<div class="info-agent">
									<span class="name">Catherine Keller</span>
									<div class="text">embarrassing hidden in the middle of tex generators on the tend to repeat predefined chunks as necessary, making this the first true </div>
									<ul class="contact">
										<li><a href="#" class="icon"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#" class="icon"><i class="fa fa-google-plus"></i></a></li>
						...
						<div class="col-sm-6 col-md-3">
							...
							<div class="agent-box-card rounded">
								...
								<div class="info-agent">
									<span class="name">Edward Fleming</span>
									<div class="text">embarrassing hidden in the middle of tex generators on the tend to repeat predefined chunks as necessary, making this the first true </div>
									<ul class="contact">
										<li><a href="#" class="icon"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#" class="icon"><i class="fa fa-google-plus"></i></a></li>
						...
						<div class="col-sm-6 col-md-3">
							...
							<div class="agent-box-card rounded">
								...
								<div class="info-agent">
									<span class="name">Erica Kelley</span>
									<div class="text">embarrassing hidden in the middle of tex generators on the tend to repeat predefined chunks as necessary, making this the first true </div>
									<ul class="contact">
										<li><a href="#" class="icon"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#" class="icon"><i class="fa fa-google-plus"></i></a></li>
						...
						<div class="row">
							<div class="col-md-3">
								<div class="counter-slide">
									<span class="timer" data-to="1204" data-from="1"></span>
									<span class="type">Properties Listed</span>
								</div>
							</div>
							<div class="col-md-3">
								<div class="counter-slide">
									<span class="timer" data-to="2693" data-from="1"></span>
									<span class="type">Day we are here</span>
								</div>
							</div>
							<div class="col-md-3">
								<div class="counter-slide">
									<span class="timer" data-to="964" data-from="1"></span>
									<span class="type">Properties Sold</span>
								</div>
							</div>
							<div class="col-md-3">
								<div class="counter-slide">
									<span class="timer" data-to="1016" data-from="1"></span>
									<span class="type">Satisfied Clients</span>
								</div>
							</div>
						</div>
					</div>
			...
			<div id="contact" class="container">
				...
				<form class="form-contact"  method="post" action="contact.php" role="form" data-toggle="validator">
					<div class="row">
						<div class="col-md-6">
							<input name="name" id="name" type="text" class="form-control" placeholder="Name (required)" required>
						</div>
						<div class="col-md-6">
						...
						<div class="col-md-12">
							<textarea name="text-message" id="text-message" class="form-control text-form" placeholder="Your message (required)" required></textarea>
						</div>
						<div class="col-md-12">
							<label>Privacy policy</label>
							<textarea class="form-control text-privacy" readonly="readonly">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum</textarea>
						</div>
						<div class="col-md-12">
	...
	<script	src="script/vendor/countTo/countTo.min.js"></script>	<!-- CountTo Script	-->
	<script	src="script/vendor/countTo/custom.js"></script>			<!-- CountTo Script	-->
