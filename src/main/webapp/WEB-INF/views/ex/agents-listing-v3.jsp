		...
		<section id="header-page" class="header-margin-base">
			<div class="skyline">
				...
				<div class="container header-text">
					<div><h1 class="title">Agents list v3</h1></div>
					<div><h2 class="sub-title">Lorem ipsum sectetur ats adipiscing elit justo</h2></div>
				</div>
			</div>
			<div id="breadcrumb">
				<div class="container">
					<ol class="breadcrumb">
						...
						<li class="active">Agents list v3</li>
					</ol>
				</div>
			</div><!-- /#breadcrumb -->
			<span class="cover"></span>
				...
				<div class="row">
					<div class="col-sm-6 col-md-3">
						...
						<div class="agent-box-card">
							...
							<div class="info-agent">
								<span class="name">Robert Phelps</span>
								<div class="text">
					...
					<div class="col-sm-6 col-md-3">
						...
						<div class="agent-box-card">
							...
							<div class="info-agent">
								<span class="name">Ruth Stone</span>
								<div class="text">
									<i class="fa fa-quote-left"></i> Embarrassing hidden in tex the middle of chunks as making necessary, this the first true <i class="fa fa-quote-right"></i>
								</div>
								<ul class="contact">
					...
					<div class="col-sm-6 col-md-3">
						...
						<div class="agent-box-card">
							...
							<div class="info-agent">
								<span class="name">Denise Jordan</span>
								<div class="text">
									<i class="fa fa-quote-left"></i> Embarrassing hidden in tex the middle of chunks as making necessary, this the first true <i class="fa fa-quote-right"></i>
								</div>
								<ul class="contact">
					...
					<div class="col-sm-6 col-md-3">
						...
						<div class="agent-box-card">
							...
							<div class="info-agent">
								<span class="name">Elizabeth Newman</span>
								<div class="text">
									<i class="fa fa-quote-left"></i> Embarrassing hidden in tex the middle of chunks as making necessary, this the first true <i class="fa fa-quote-right"></i>
								</div>
								<ul class="contact">
