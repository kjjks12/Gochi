...
<html lang="en">
  ...
  <body class="fixed-header">
		...
		<section id="header-page" class="header-margin-base">
			<div class="skyline">
				...
				<div class="container header-text">
					<div><h1 class="title">Blog list v3</h1></div>
					<div><h2 class="sub-title">Lorem ipsum dolorur ats adipiscing elit justo</h2></div>
				</div>
			</div>
			<div id="breadcrumb">
				<div class="container">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-9" id="blog-list">
						<div class="item">
							<div class="blog-list masonry-post">
								...
								<div class="image">
									...
									<div class="social">
										<span class="date">22<span>Apr</span></span>
						...
						<div class="item">
							<div class="blog-list masonry-post">
								<h2 class="title"><a href="blog-detail.html">Mauris sed lobortis dui</a></h2>
								<div class="image">
									<img src="http://placehold.it/670x960/bbbbbb/ffffff" alt="Image Sample" class="img-responsive" />
									<div class="social">
										<span class="date">4<span>Apr</span></span>
										<a href="#"><i class="fa fa-heart-o"></i><span>1653</span></a>
										<a href="#"><i class="fa fa-eye"></i><span>564972</span></a>
										<a href="#"><i class="fa fa-comments"></i><span>136</span></a>
									</div>
								</div>
								<div class="text">
									<h3 class="subtitle">Internet tend to repeat predefined chunks.</h3>
									Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent molestie in ipsumolestie. Suspendisse pulvinar libero enim, et finibus massa commodo vitae.
								</div>
								<input type="button" value="Read now" class="btn btn-default button-read" />
							</div>
						</div><!-- /.item -->
						...
						<div class="item">
							<div class="blog-list masonry-post">
								<h2 class="title"><a href="blog-detail.html">Pellentesque placerat neque maximus interdum lobortis</a></h2>
								<div class="image">
									<img src="http://placehold.it/700x900/bbbbbb/ffffff" alt="Image Sample" class="img-responsive" />
									<div class="social">
										<span class="date">22<span>Mar</span></span>
										<a href="#"><i class="fa fa-heart-o"></i><span>698</span></a>
										<a href="#"><i class="fa fa-eye"></i><span>346597</span></a>
										<a href="#"><i class="fa fa-comments"></i><span>45</span></a>
									</div>
								</div>
								<div class="text">
									<h3 class="subtitle">Finibus massa commodo vitae</h3>
									Lorem ipsum dolor sit amet, consectetur adipiscing elitie. Duis sodales tinvinar libero enim, et finibus massa commodo vitae.
								</div>
								<input type="button" value="Read now" class="btn btn-default button-read" />
							</div>
						</div><!-- /.item -->
						...
						<div class="item">
							<div class="blog-list masonry-post">
								<h2 class="title"><a href="blog-detail.html">Pellentesque in elit vel lacus</a></h2>
								<div class="image">
									<img src="http://placehold.it/1280x850/bbbbbb/ffffff" alt="Image Sample" class="img-responsive" />
									<div class="social">
										<span class="date">18<span>Mar</span></span>
										<a href="#"><i class="fa fa-heart-o"></i><span>453</span></a>
										<a href="#"><i class="fa fa-eye"></i><span>65900</span></a>
										<a href="#"><i class="fa fa-comments"></i><span>35</span></a>
									</div>
								</div>
								<div class="text">
									<h3 class="subtitle">Internet tend to repeat predefined chunks.</h3>
									Lorem ipsum dolor sit amet, consectetur adstibulum. Proin aulvinar libero enim, et finibus massa commodo vitae.
								</div>
								<input type="button" value="Read now" class="btn btn-default button-read" />
							</div>
						</div><!-- /.item -->
						...
						<div class="item">
							<div class="blog-list masonry-post">
								<h2 class="title"><a href="blog-detail.html">Suspendisse tempus quam eu dui </a></h2>
								<div class="image">
									<img src="http://placehold.it/670x960/bbbbbb/ffffff" alt="Image Sample" class="img-responsive" />
									<div class="social">
										<span class="date">7<span>Mar</span></span>
										<a href="#"><i class="fa fa-heart-o"></i><span>356</span></a>
										<a href="#"><i class="fa fa-eye"></i><span>643795</span></a>
										<a href="#"><i class="fa fa-comments"></i><span>65</span></a>
									</div>
								</div>
								<div class="text">
									<h3 class="subtitle">Internet tend to repeat predefined chunks.</h3>
						...
						<div class="item">
							<div class="blog-list masonry-post">
								<h2 class="title"><a href="blog-detail.html">Donec a orci fermentum</a></h2>
								<div class="image">
									<img src="http://placehold.it/700x900/bbbbbb/ffffff" alt="Image Sample" class="img-responsive" />
									<div class="social">
										<span class="date">29<span>Feb</span></span>
										<a href="#"><i class="fa fa-heart-o"></i><span>642</span></a>
										<a href="#"><i class="fa fa-eye"></i><span>102798</span></a>
										<a href="#"><i class="fa fa-comments"></i><span>45</span></a>
									</div>
								</div>
								<div class="text">
	...
	<script	src="script/vendor/grid-a-licious/grid-a-licious.min.js"></script>		<!-- Masonry Script	-->
