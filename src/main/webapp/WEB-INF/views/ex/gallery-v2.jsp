...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/vendor/magnific-popup/magnific-popup.css">     <!-- Gallery Effect -->
  ...
  <body class="fixed-header">
	...
	<div id="page-container">
		...
		<section id="header-page" class="header-margin-base">
			<div class="skyline">
				...
				<div class="container header-text">
					<div><h1 class="title">Gallery / Masonry</h1></div>
					<div><h2 class="sub-title">Lorem ipsum dolor sitectetur adipiscing elit justo</h2></div>
				</div>
			</div>
			<div id="breadcrumb">
				<div class="container">
		...
		<section id="gallery">
			<div class="container">
				<ul id="images-container" class="masonry-images">
					<li class="item">
						<a href="http://placehold.it/1280x850/bbbbbb/ffffff" data-collection="group-one" class="hover-effect masonryGalleryItem">
							<img src="http://placehold.it/1280x850/bbbbbb/ffffff" alt="Image Sample" class="img-responsive" />
							<span class="cover"></span>
							<span class="cover-title">Lorem ipsum node</span>
						</a>
					</li>
					<li class="item">
						<a href="http://placehold.it/1280x850/bbbbbb/ffffff" data-collection="group-one" class="hover-effect masonryGalleryItem">
					...
					<li class="item">
						<a href="http://placehold.it/1280x680/bbbbbb/ffffff" data-collection="group-one" class="hover-effect masonryGalleryItem">
					...
					<li class="item">
						<a href="http://placehold.it/670x960/bbbbbb/ffffff" data-collection="group-one" class="hover-effect masonryGalleryItem">
					...
					<li class="item">
						<a href="http://placehold.it/700x900/bbbbbb/ffffff" data-collection="group-one" class="hover-effect masonryGalleryItem">
					...
					<li class="item">
						<a href="http://placehold.it/1240x745/bbbbbb/ffffff" data-collection="group-one" class="hover-effect masonryGalleryItem">
							<img src="http://placehold.it/1240x745/bbbbbb/ffffff" alt="Image Sample" class="img-responsive" />
							<span class="cover"></span>
							<span class="cover-title">Lorem ipsum node</span>
						</a>
					</li>
					<li class="item">
						<a href="http://placehold.it/580/bbbbbb/ffffff" data-collection="group-one" class="hover-effect masonryGalleryItem">
							<img src="http://placehold.it/580/bbbbbb/ffffff" alt="Image Sample" class="img-responsive" />
							<span class="cover"></span>
							<span class="cover-title">Lorem ipsum node</span>
						</a>
					</li>
