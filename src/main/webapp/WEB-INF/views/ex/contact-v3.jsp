	...
	<div id="page-container">
		...
		<section id="header-page" class="header-margin-base">
			<div class="skyline">
				...
				<div class="container header-text">
					<div><h1 class="title">Contact v3</h1></div>
					<div><h2 class="sub-title">Lorem ipsum dolorsectetur adipiscing elit justo</h2></div>
				</div>
			</div>
			<div id="breadcrumb">
				<div class="container">
		...
		<section id="contact">
			<div class="section-detail">
				<h1>Contact</h1>
				<h2>Lorem ipsum dolor, consectetur adipiscing elittis sed elementum dignissim, lobortis.</h2>		
			</div>
			<div class="container">
				<div class="row">
					<div class="col-md-12">
