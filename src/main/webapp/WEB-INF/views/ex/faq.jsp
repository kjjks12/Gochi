				...
				<div class="row">
					<div class="col-sm-3" id="block-menu-content">
						...
						<ul class="block-menu" data-spy="affix" data-offset-top="500" data-offset-bottom="400">
							<li><a class="faq-button active" href="#basic"><i class="icon fa fa-life-ring"></i> Basics</a></li>
							<li><a class="faq-button" href="#account"><i class="icon fa fa-child"></i> Account</a></li>
							<li><a class="faq-button" href="#property"><i class="icon fa fa-home"></i> Property</a></li>
							<li><a class="faq-button" href="#selling"><i class="icon fa fa-cart-plus"></i> Selling Process</a></li>
							<li><a class="faq-button" href="#buying"><i class="icon fa fa-university"></i> Buying Process</a></li>
							<li><a class="faq-button" href="#agent"><i class="icon fa fa-user-secret"></i> Agent Contact</a></li>
						</ul>
					</div>
					<div class="col-sm-9">
						...
						<div class="faq-container accordion" id="basic">
							...
							<div class="accordion-box">
								<a data-target="#acc-6" href="#" class="title">Mauris tristique massa vel metus sollicitudin?</a>
						...
						<div class="faq-container accordion" id="account">
							<div class="accordion-box">
								<a data-target="#acc-7" href="#" class="title">Donec feugiat magna justo. Sed dignissim at metus vel commodo?</a>
							...
							<div class="accordion-box">
								<a data-target="#acc-8" href="#" class="title">Curabitur pulvinar luctus tristique?</a>
						...
						<div class="faq-container accordion" id="property">
							<div class="accordion-box">
								<a data-target="#acc-10" href="#" class="title">Donec feugiat magna justo. Sed dignissim at metus vel commodo?</a>
							...
							<div class="accordion-box">
								<a data-target="#acc-11" href="#" class="title">Curabitur pulvinar luctus tristique?</a>
							...
							<div class="accordion-box">
								<a data-target="#acc-12" href="#" class="title">Mauris tristique massa vel metus sollicitudin?</a>
						...
						<div class="faq-container accordion" id="selling">
							<div class="accordion-box">
								<a data-target="#acc-13" href="#" class="title">Donec feugiat magna justo. Sed dignissim at metus vel commodo?</a>
							...
							<div class="accordion-box">
								<a data-target="#acc-14" href="#" class="title">Curabitur pulvinar luctus tristique?</a>
						...
						<div class="faq-container accordion" id="buying">
							<div class="accordion-box">
								<a data-target="#acc-16" href="#" class="title">Donec feugiat magna justo. Sed dignissim at metus vel commodo?</a>
								<div class="text-container" id="acc-16">
									<p>Donec feugiat magna justo. Sed dignissim at metus vel commodo. Vivamus vehicula eget urna a mattis. Donec ac ornare ipsum. Nullam sagittis sem dolor, id lobortis sapien iaculis at. Curabitur risus erat, blandit quis diam ut, pharetra convallis tortor. Curabitur pulvinar luctus tristique. Fusce sagittis ligula ac mattis elementum. Sed at elit ante. Integer odio nunc, ultricies gravida imperdiet ac, viverra iaculis lorem. Donec scelerisque magna mauris, id rutrum mauris iaculis nec. Mauris tristique massa vel metus sollicitudin, ac porta nisi tempus. Nullam id aliquam urna. Proin a lorem dignissim, sollicitudin tortor nec, accumsan lectus.</p>
									<span class="footer">
										Was this answer helpful? 
										<a href="#"><i class="fa fa-thumbs-o-up"></i></a> 
							...
							<div class="accordion-box">
								<a data-target="#acc-17" href="#" class="title">Curabitur pulvinar luctus tristique?</a>
								<div class="text-container" id="acc-17">
									<p>Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integerut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sitamet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo utodio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate. Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integerut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sitamet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo utodio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.</p>
									<span class="footer">
										Was this answer helpful? 
										<a href="#"><i class="fa fa-thumbs-o-up"></i></a> 
							...
							<div class="accordion-box">
								<a data-target="#acc-18" href="#" class="title">Mauris tristique massa vel metus sollicitudin?</a>
								<div class="text-container" id="acc-18">
									<p>Cras dictum. Pellosuere cubilia Curae; Aenean laciniamauris vel est.</p>
									<p>Donec ac ornare ipsum. Nullam sagittis sem dolor, id lobortis sapien iaculis at. Curabitur risus erat, blandit quis diam ut, pharetra convallis tortor. Curabitur pulvinar luctus tristique. Fusce sagittis ligula ac mattis elementum. Sed at elit ante. Integer odio nunc, ultricies gravida imperdiet ac, viverra iaculis lorem. Donec scelerisque magna mauris, id rutrum mauris.</p>
									<span class="footer">
										Was this answer helpful? 
						...
						<h2>Agent Contact</h2>
						<div class="faq-container accordion" id="agent">
							<div class="accordion-box">
								<a data-target="#acc-19" href="#" class="title">Donec feugiat magna justo. Sed dignissim at metus vel commodo?</a>
								<div class="text-container" id="acc-19">
									<p>Donec feugiat magna justo. Sed dignissim at metus vel commodo. Vivamus vehicula eget urna a mattis. Donec ac ornare ipsum. Nullam sagittis sem dolor, id lobortis sapien iaculis at. Curabitur risus erat, blandit quis diam ut, pharetra convallis tortor. Curabitur pulvinar luctus tristique. Fusce sagittis ligula ac mattis elementum. Sed at elit ante. Integer odio nunc, ultricies gravida imperdiet ac, viverra iaculis lorem. Donec scelerisque magna mauris, id rutrum mauris iaculis nec. Mauris tristique massa vel metus sollicitudin, ac porta nisi tempus. Nullam id aliquam urna. Proin a lorem dignissim, sollicitudin tortor nec, accumsan lectus.</p>
									<span class="footer">
										Was this answer helpful? 
										<a href="#"><i class="fa fa-thumbs-o-up"></i></a> 
							...
							<div class="accordion-box">
								<a data-target="#acc-20" href="#" class="title">Curabitur pulvinar luctus tristique?</a>
								<div class="text-container" id="acc-20">
									<p>Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integerut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sitamet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo utodio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate. Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integerut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sitamet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo utodio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.</p>
									<span class="footer">
										Was this answer helpful? 
										<a href="#"><i class="fa fa-thumbs-o-up"></i></a> 
							...
							<div class="accordion-box">
								<a data-target="#acc-21" href="#" class="title">Mauris tristique massa vel metus sollicitudin?</a>
								<div class="text-container" id="acc-21">
									<p>Cras dictum. Pellosuere cubilia Curae; Aenean laciniamauris vel est.</p>
									<p>Donec ac ornare ipsum. Nullam sagittis sem dolor, id lobortis sapien iaculis at. Curabitur risus erat, blandit quis diam ut, pharetra convallis tortor. Curabitur pulvinar luctus tristique. Fusce sagittis ligula ac mattis elementum. Sed at elit ante. Integer odio nunc, ultricies gravida imperdiet ac, viverra iaculis lorem. Donec scelerisque magna mauris, id rutrum mauris.</p>
									<span class="footer">
										Was this answer helpful? 
							...
							<div class="accordion-box">
								<a data-target="#acc-22" href="#" class="title active">Curabitur pulvinar luctus tristique?</a>
								<div class="text-container open" id="acc-22">
									<p>Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integerut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sitamet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo utodio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate. Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integerut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sitamet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo utodio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.</p>
									<span class="footer">
										Was this answer helpful? 
										<a href="#"><i class="fa fa-thumbs-o-up"></i></a> 
							...
							<div class="accordion-box">
								<a data-target="#acc-23" href="#" class="title">Mauris tristique massa vel metus sollicitudin?</a>
								<div class="text-container" id="acc-23">
									<p>Cras dictum. Pellosuere cubilia Curae; Aenean laciniamauris vel est.</p>
									<p>Donec ac ornare ipsum. Nullam sagittis sem dolor, id lobortis sapien iaculis at. Curabitur risus erat, blandit quis diam ut, pharetra convallis tortor. Curabitur pulvinar luctus tristique. Fusce sagittis ligula ac mattis elementum. Sed at elit ante. Integer odio nunc, ultricies gravida imperdiet ac, viverra iaculis lorem. Donec scelerisque magna mauris, id rutrum mauris.</p>
									<span class="footer">
										Was this answer helpful? 
							...
							<div class="accordion-box">
								<a data-target="#acc-24" href="#" class="title">Donec feugiat magna justo. Sed dignissim at metus vel commodo?</a>
								<div class="text-container" id="acc-24">
									<p>Donec feugiat magna justo. Sed dignissim at metus vel commodo. Vivamus vehicula eget urna a mattis. Donec ac ornare ipsum. Nullam sagittis sem dolor, id lobortis sapien iaculis at. Curabitur risus erat, blandit quis diam ut, pharetra convallis tortor. Curabitur pulvinar luctus tristique. Fusce sagittis ligula ac mattis elementum. Sed at elit ante. Integer odio nunc, ultricies gravida imperdiet ac, viverra iaculis lorem. Donec scelerisque magna mauris, id rutrum mauris iaculis nec. Mauris tristique massa vel metus sollicitudin, ac porta nisi tempus. Nullam id aliquam urna. Proin a lorem dignissim, sollicitudin tortor nec, accumsan lectus.</p>
									<span class="footer">
										Was this answer helpful? 
										<a href="#"><i class="fa fa-thumbs-o-up"></i></a> 
