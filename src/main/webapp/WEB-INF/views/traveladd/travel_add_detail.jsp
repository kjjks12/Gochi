...
#map {margin-top: 10px;}
  ...
  <body class="fixed-header">
			...
			<div id="breadcrumb">
				<div class="container">
					<ol class="breadcrumb">
						...
						<a data-toggle="modal" data-target="#myMap">map</a>
	...
	<section>
		...
		<div class="modal fade" id="myMap" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="z-index: 1000" >
