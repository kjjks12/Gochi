...
<script type="text/javascript"
	src="//apis.daum.net/maps/maps3.js?apikey=a39e6160d10aea82c49d95d61746babb&libraries=drawing"></script>
<style>
.map_wrap {
	width: 100%;
	position: relative;
...
<body class="fixed-header">
	...
	<div id="page-container">
			...
			<div class="skyline" id="user_backcover_div">
				...
				<div class="container header-text">
					<div class="profile_title_div">
						<h1 align="center">
							<span id="travel_title_span"> <span id="travel_title">${requestScope.travelDTO.title}</span>
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-xs-9 col-sm-9 col-md-9  col-lg-10">
						...
						<div id="story">
							<form method="post" action="contact.php" class="form-large"
								...
								<textarea class="form-control" id="planDetailMessage" rows="10"
									placeholder="당신의 여행 스토리를 남겨보세요!" maxlength="10000">${requestScope.travelDTO.briefStory}</textarea>
						...
						<!-- 여행 시작 날짜 / 여행테마 -->
						<div class="travelDate_div">
							<table class="travelDate_table">
								<tr>
									<th><span>시작날짜</span></th>
									<td><input class="datepicker form-control" type="text"
										id="indate2" placeholder="Check-in: YYYY/MM/DD"
										style="width: 200px" name="travelStartDay" value="${requestScope.travelDTO.travelStartDay}" /></td>

									<th><span>끝 날짜</span></th>
									<td><input class="datepicker form-control" type="text"
										id="outdate2" placeholder="Check-out: YYYY/MM/DD"
										style="width: 200px; margin-left: 20px" name="travelEndDay"  value="${requestScope.travelDTO.travelEndDay}"/>
									</td>
									<th><span>테마</span></th>
									<td><select id="capa" name="thema"  id="thema">
						...
						<div id="map_itinerary_section">
							...
							<div id="weather_div" class="weather_div">
								<h3>날씨 영역 이에요</h3>
							</div>
		...
		<div class="modal fade" id=detailmap tabindex="-1" role="dialog"
			...
			style="width: 100%;">
			<div class="modal-content"
				style="background-clip: border-box; width: 90%;">
				<div class="modal-header">
					<h3>여행일정 디테일 (가제~)</h3>
					<button type="button" class="close" data-dismiss="modal">
						<span aria-hidden="true">&times;</span><span class="sr-onl;y">Close</span>
					</button>
					...
					<div class="map_wrap">
						...
						<p class="modes">
							...
							<button class="btn btn-reverse"
								onclick="selectOverlay('POLYLINE')">선</button>
							<button class="btn btn-reverse" onclick="selectOverlay('CIRCLE')">원</button>
							<button class="btn btn-reverse"
								onclick="selectOverlay('RECTANGLE')">사각형</button>
							<button class="btn btn-reverse"
								onclick="selectOverlay('POLYGON')">다각형</button>
						</p>
