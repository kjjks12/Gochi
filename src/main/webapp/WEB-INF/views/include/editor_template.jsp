						...
						<div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
							...
							<div class="tx-menu-footer">
								<img class="tx-menu-confirm"
									 src="${pageContext.request.contextPath}/resources/editor/images/icon/editor/btn_confirm.gif?rv=1.0.1" alt=""/>
								<img class="tx-menu-cancel" hspace="3"
									 src="${pageContext.request.contextPath}/resources/editor/images/icon/editor/btn_cancel.gif?rv=1.0.1" alt=""/>
							</div>
						</div>
					</li>
					<li class="tx-list">
...
function setConfig() {
	alert(1)
	  var config = {
				...
				wrapper: "tx_trex_container", /* 에디터를 둘러 싸고 있는 레이어 이름(에디터 컨테이너) */
...
setConfig()
	...
	$(function(){
		...
		/*  $.ajax({
	        type:"get",
	        url: "${pageContext.request.contextPath}/resources/editor/editor_template.jsp",
		...
		/* $("#content").click(function(){
			//$("#content").load("${pageContext.request.contextPath}/resources/editor/test.html");
			
			$.ajax({
		        type:"get",
		        url: "${pageContext.request.contextPath}/resources/editor/test.html",
		        success: function(data){
		        	alert(data)
		        	$("#content").html(data);
		        	//setConfig();
		...
		//$("#content").load("${pageContext.request.contextPath}/resources/editor/test.jsp");
	//setConfig();
	})
